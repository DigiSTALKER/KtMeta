...
public class AddDatabaseWizard extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        CBAvailableDBMS = new javax.swing.JComboBox<>();
        ...
        FieldAlias.setText("Alias name of database");
        ...
        FieldDescription.setText("Description of database");
        ...
        LabelDBMS.setText("DBMS : ");

        CBAvailableDBMS.setModel(new javax.swing.DefaultComboBoxModel<>(SupportedDatabaseList));
        CBAvailableDBMS.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                CBAvailableDBMSItemStateChanged(evt);
            }
        });

        LabelJDBCURL.setText("JDBC URL : ");
                                                ...
                                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                                        .addGroup(layout.createSequentialGroup()
                                                                ...
                                                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                                                        ...
                                                                        .addComponent(FieldDescription, javax.swing.GroupLayout.DEFAULT_SIZE, 371, Short.MAX_VALUE)
                                                                        .addComponent(CBAvailableDBMS, javax.swing.GroupLayout.Alignment.LEADING, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                                                        .addGroup(layout.createSequentialGroup()
                                                                .addComponent(LabelJDBCURL)
                                                                .addGap(18, 18, 18)
                                                                .addComponent(FieldJDBCURL, javax.swing.GroupLayout.PREFERRED_SIZE, 371, javax.swing.GroupLayout.PREFERRED_SIZE))
                                                        .addGroup(layout.createSequentialGroup()
                                                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        layout.setVerticalGroup(
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        .addComponent(LabelDBMS)
                                        .addComponent(CBAvailableDBMS, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        .addComponent(LabelJDBCURL)
    ...
    private void FieldJDBCURLMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_FieldJDBCURLMouseClicked
        this.FieldJDBCURL.setForeground(new java.awt.Color(0, 0, 0));
        this.FieldJDBCURL.selectAll();
    ...
    private void FieldUsernameMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_FieldUsernameMouseClicked
        if (this.FieldUsername.isEnabled()) {
            this.FieldUsername.setForeground(new java.awt.Color(0, 0, 0));
            this.FieldUsername.selectAll();
        }
    ...
    private void FieldPasswordMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_FieldPasswordMouseClicked
        if (this.FieldPassword.isEnabled()) {
            this.FieldPassword.setForeground(new java.awt.Color(0, 0, 0));
    ...
    private void CBAvailableDBMSItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_CBAvailableDBMSItemStateChanged
        KtCBAvailableDBMSItemStateChanged();
    }//GEN-LAST:event_CBAvailableDBMSItemStateChanged
    ...
    protected void KtCBAvailableDBMSItemStateChanged() {
        // TODO
    }
    ...
    protected javax.swing.JComboBox<String> CBAvailableDBMS;
